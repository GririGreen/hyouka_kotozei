...
const PropertyTaxCalculator = () => {
  ...
  const [ownershipDenominator, setOwnershipDenominator] = useState("10,000")
  ...
  const calculateOwnership = () => {
    const numerator = parseNumber(ownershipNumerator) || 0
    const denominator = parseNumber(ownershipDenominator) || 1
